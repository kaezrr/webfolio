...
date: 2026-02-07
tags: ['playstation', 'rust', 'emulators', 'optimization']
draft: false
---
...
I also want to explore Profile-Guided Optimization (<abbr title="Profile-Guided Optimization">PGO</abbr>) too sometime in the future, but overall I think these are all good results: around a **79% increase** in runtime performance (**29fps** to **52fps**) without changing a single line of code.
